...
getEmployees = function(employees) {
    ...
    return `${employees.map((employee)=> {
        ...
        if(employee.constructor.name === 'Engineer'){
            return `
            <li class="col-span-1 bg-green-50 shadow divide-y divide-gray-500">
            ...
            // HTML for interns
            return `<!-- INTERN -->
            <li class="col-span-1 bg-yellow-50 shadow divide-y divide-gray-500">
              <div class="w-full flex items-center justify-between p-6 space-x-6">
                <div class="flex-1">
                  <div class="flex items-center space-x-3">
                    <h3 class="text-gray-900 text-sm font-medium">${employee.getName()}</h3>
    ...
    <body class="container mx-auto bg-gray-200">
        ...
        <main>
            <ul class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 py-5 px-5">
                <!-- MANAGER -->
                <li class="col-span-1 bg-blue-50 shadow divide-y divide-gray-500">
                    <div class="w-full flex items-center justify-between p-6 space-x-6">
                      <div class="flex-1">
                        <div class="flex items-center space-x-3">
